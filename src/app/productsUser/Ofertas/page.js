...
export default function Page() {
    ...
    useEffect(() => {
        ...
        // Filtra os produtos por redirection = "ofertas"
        const filteredProducts = storedProducts.filter((product) =>
            product.redirection && product.redirection.toLowerCase() === "ofertas"
        );
            ...
            <Container style={{margin:"0rem 0rem 0rem 2rem", padding:"2rem 0rem 0rem 2rem"}} className="my-3">
                <Row style={{width:"1400px"}}>
                    ...
                    <Col md={12}>
                        ...
                        <h4 className="mb-5" style={{display:"flex", justifyContent:"center", alignItems:"center", marginTop:"4rem", fontSize:"5rem"}}>Produtos Em Ofertas</h4>
